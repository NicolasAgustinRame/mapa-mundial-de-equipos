var markers = [
    L.marker([-34.635611, -58.364791], { icon: imagen }).bindPopup("Club Atlético Boca Juniors"),
    L.marker([-34.545278, -58.449722], { icon: imagen2 }).bindPopup("Club Atlético River Plate"),
    L.marker([-31.44896, -64.17565], { icon: imagen3 }).bindPopup("Club Atlético Talleres de Córdoba"),
